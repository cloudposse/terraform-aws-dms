...
| Name | Type |
|------|------|
| [aws_dms_event_subscription.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/dms_event_subscription) | resource |
...
| <a name="input_event_categories"></a> [event\_categories](#input\_event\_categories) | List of event categories to listen for. See https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-event-categories.html for more details | `list(string)` | `null` | no |
| <a name="input_event_subscription_enabled"></a> [event\_subscription\_enabled](#input\_event\_subscription\_enabled) | Whether the event subscription should be enabled | `bool` | `true` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_event_subscription_arn"></a> [event\_subscription\_arn](#output\_event\_subscription\_arn) | Event subscription ARN |
